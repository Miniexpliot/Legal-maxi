    ...
    <div className="space-y-6 animate-fade-in pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400">Standard legal contract templates ready for customization and workspace analysis.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-3">
          <h3 className="text-xs font-semibold text-slate-300 uppercase tracking-wider">Available Templates</h3>
            ...
            {CONTRACT_TEMPLATES.map((tmpl) => (
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <h4 className="text-xs font-bold font-heading">{tmpl.title}</h4>
                  <span className="badge badge-primary text-[9px]">{tmpl.category}</span>
                </div>
        ...
        <div className="lg:col-span-2 glass-panel p-6 border border-slate-800 flex flex-col space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <div>
              <h3 className="text-sm font-bold text-white font-heading">{selectedTemplate.title}</h3>
              <p className="text-[11px] text-slate-400">{selectedTemplate.category} Template</p>
            </div>
          ...
          <div className="font-mono text-xs text-slate-300 bg-slate-950 p-4 rounded-xl border border-slate-800 leading-relaxed whitespace-pre-wrap flex-1 min-h-[350px]">
