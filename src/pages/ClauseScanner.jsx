    ...
    <div className="space-y-6 animate-fade-in pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400">Scan agreements for hidden risks, liquidated damages, unilateral terms, and liabilities.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="space-y-4">
          <button
            ...
            className="w-full btn-primary py-3 flex items-center justify-center gap-2 bg-gradient-to-r from-rose-600 to-amber-600"
          >
            <Sparkles className="w-4 h-4" />
            <span>Scan Active Document for High Risk Clauses</span>
          </button>
        ...
        <div className="glass-panel p-6 border border-slate-800 flex flex-col min-h-[500px]">
          ...
          {loading ? (
            <div className="flex-1 flex items-center justify-center">
              <LoadingSpinner label="Auditing clauses for risk metrics and hidden legal traps..." />
            </div>
          ) : output ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center text-slate-500 py-12">
              ...
              <p className="text-xs max-w-xs mt-1">Click the scan button above to analyze your active document.</p>
            </div>
          )}
        </div>
      </div>
